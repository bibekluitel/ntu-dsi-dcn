...
//calculate traceffile
			...
			p2p.EnableAsciiAll(ascii.CreateFileStream("fattreebilalp2p.tr"));  //p2p is  a pointToPointHelper
			csma.EnableAsciiAll(ascii.CreateFileStream("fattreebilalcsma.tr"));  // csma is  a csmaHelper

//enable pcap
			p2p.EnablePcapAll("statistics/fat-treebilal/p2p");	// p2p is  a pointToPointHelper
			csma.EnablePcapAll("statistics/bcube/csma");     // csma is  a csmaHelper
