...
//
	...
	char filename [] = "statistics/fattreealfares/Fat-tree-AlFares.xml";// filename for Flow Monitor xml output file
...
//
	...
	DataRate dataRate_OnOff("96Mbps");
...
//calculate traceffile
			...
			p2p.EnableAsciiAll(ascii.CreateFileStream("fattreealfaresp2p.tr"));  //p2p is  a pointToPointHelper
			csma.EnableAsciiAll(ascii.CreateFileStream("fattreealfarescsma.tr"));  // csma is  a csmaHelper

//enable pcap
			p2p.EnablePcapAll("statistics/fattreealfares/p2p");	// p2p is  a pointToPointHelper
			csma.EnablePcapAll("statistics/fattreealfares/csma");     // csma is  a csmaHelper
